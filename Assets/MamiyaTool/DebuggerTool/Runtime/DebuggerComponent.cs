...
namespace MamiyaTool {
    ...
    [AddComponentMenu("Mamiya Tool/Debugger")]
    public sealed partial class DebuggerComponent : MonoBehaviour {
        internal static float deltaX = 0f;
        internal static float deltaY = 60f;
        /// <summary>
        /// 默认调试器漂浮框大小。
        /// </summary>
        internal static readonly Rect DefaultIconRect = new Rect(10f + deltaX, 10f + deltaY, 60f, 60f);

        /// <summary>
        /// 默认调试器窗口大小。
        /// </summary>
        internal static readonly Rect DefaultWindowRect = new Rect(10f + deltaX, 10f + deltaY, 640f, 480f);
