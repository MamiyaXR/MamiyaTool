...
namespace MamiyaTool {
    internal class DirectorStyles {
        public static GUIContent pointIcon = EditorGUIUtility.TrIconContent("animationkeyframe");
        ...
        public static GUIStyle optionsButton = GUI.skin.GetStyle("toolbarbuttonRight");
        public static GUIStyle miniToolbarButton = new GUIStyle(EditorStyles.toolbarButton);
        public static GUIStyle toolbarLabel = new GUIStyle(DirectorStyles.animClipToolbarPopup);

        public static GUIStyle trackMinusBtn = GUI.skin.GetStyle("OL Minus");
        public static GUIStyle trackPlusBtn = GUI.skin.GetStyle("OL Plus");
        public static GUIStyle trackEnableToggle = GUI.skin.GetStyle("MenuToggleItem");
        public static GUIStyle trackPathField = GUI.skin.GetStyle("ToolbarSearchTextFieldJumpButton");
