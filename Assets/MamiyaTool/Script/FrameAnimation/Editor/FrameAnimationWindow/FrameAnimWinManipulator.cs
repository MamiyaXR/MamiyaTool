...
namespace MamiyaTool {
    internal class FrameAnimWinManipulator {
        public delegate bool OnStartDragDelegate(FrameAnimWinManipulator manipulator, Event evt);
        public delegate bool OnDragDelegate(FrameAnimWinManipulator manipulator, Event evt);
        public delegate bool OnEndDragDelegate(FrameAnimWinManipulator manipulator, Event evt);
         ...
         * 
         *****************************************************************/
        public FrameAnimWinManipulator() {
            onStartDrag += (manipulator, evt) => { return false; };
            onDrag += (manipulator, evt) => { return false; };
            onEndDrag += (manipulator, evt) => { return false; };
        }
    ...
    internal class AreaManipulator : FrameAnimWinManipulator {
    ...
    internal class TimeCursorManipulator : FrameAnimWinManipulator {
