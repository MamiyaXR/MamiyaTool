...
namespace MamiyaTool {
    internal class SplitterGUILayout {
        ...
        public static object FromRelative(float[] relativeSizes, float[] minSizes, float[] maxSizes) {
            return fromRelative.Value.Invoke(null, new object[] { relativeSizes, minSizes, maxSizes });
        }
