        ...
        private sealed class ConsoleWindow : IDebuggerWindow {
            ...
            public void OnDraw() {
                ...
                GUILayout.BeginHorizontal();
                {
                    ...
                    m_InfoFilter = GUILayout.Toggle(m_InfoFilter, $"Info ({m_InfoCount})", GUILayout.Width(90f));
                    m_WarningFilter = GUILayout.Toggle(m_WarningFilter, $"Warning ({m_WarningCount})", GUILayout.Width(90f));
                    m_ErrorFilter = GUILayout.Toggle(m_ErrorFilter, $"Error ({m_ErrorCount})", GUILayout.Width(90f));
                    m_FatalFilter = GUILayout.Toggle(m_FatalFilter, $"Fatal ({m_FatalCount})", GUILayout.Width(90f));
                }
            ...
            public void RefreshCount() {
                ...
                foreach(LogNode logNode in m_LogNodes) {
                    switch(logNode.LogType) {
                        ...
                        case LogType.Exception: m_FatalCount++; break;
                    }
                }
            }
            ...
            internal Color32 GetLogStringColor(LogType logType) {
                ...
                switch(logType) {
                    case LogType.Log: color = m_InfoColor; break;
                    case LogType.Warning: color = m_WarningColor; break;
                    case LogType.Error: color = m_ErrorColor; break;
                    case LogType.Exception: color = m_FatalColor; break;
                }
                return color;
            }
        }
